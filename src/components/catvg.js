...
const Catvg = () => {
  ...
  const [leftEyeX, setLeftEyeX] = useState('170.8')
  const [leftEyeY, setLeftEyeY] = useState('332.51')
  const [rightEyeX, setRightEyeX] = useState('426.63')
  const [rightEyeY, setRightEyeY] = useState('332.51')

  return (
    <>
      <svg
        xmlns='http://www.w3.org/2000/svg'
        viewBox='0 0 651.37 525.73'
        className='catvg'
        id='anchor'
      >
        <defs>
